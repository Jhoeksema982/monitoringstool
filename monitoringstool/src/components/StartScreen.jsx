...
const StartScreen = ({ onStart }) => {
  return (
    <div className="flex flex-col items-center bg-teal-800 text-white py-24 px-12 overflow-hidden">
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="mb-6 text-gray-200">
          Kies hieronder of het gaat om een regulier bezoek of een ouder-kind
          dag.
        </p>
